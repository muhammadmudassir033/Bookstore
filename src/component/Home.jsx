        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-150 rounded-lg shadow-md overflow-hidden flex">
            ...
            <div className="w-1/2 p-4 flex flex-col justify-between">
              ...
              <p className="text-[#6251DD]  text-xl font-semibold">$24.99</p>
            </div>
          </div>
          ...
          <div className="bg-gray-150 rounded-lg shadow-md overflow-hidden flex">
            ...
            <div className="w-1/2 p-4 flex flex-col justify-between">
              ...
              <p className="text-[#6251DD]  text-xl  font-semibold">$19.99</p>
            </div>
          </div>
          ...
          <div className="bg-gray-150 rounded-lg shadow-md overflow-hidden flex">
            ...
            <div className="w-1/2 p-4 flex flex-col justify-between">
              <h4 className="text-lg font-bold">Dune</h4>
              <p className="text-[#6251DD]  text-xl  font-semibold">$87.75</p>
            </div>
          </div>
          ...
          <div className="bg-gray-150 rounded-lg shadow-md overflow-hidden flex">
            ...
            <div className="w-1/2 p-4 flex flex-col justify-between">
              ...
              <p className="text-[#6251DD]  text-xl  font-semibold">$35.75</p>
            </div>
          </div>
        </div>
      </div>
